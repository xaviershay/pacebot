...
(function(Opal) {
  ...
  Opal.add_stubs(['$match', '$captures', '$to_f', '$map', '$to_proc', '$split', '$[]', '$new', '$to_seconds', '$==', '$to_s', '$size', '$+', '$*', '$<', '$%', '$round', '$>=', '$/', '$format_duration', '$seconds', '$distance', '$identifier', '$raise', '$miles']);
  return (function($base, $super) {
    function $Pacebot(){};
    ...
    def.$parse = function(msg) {
      var $a, $b, $c, self = this, distance_matcher = nil, pace_matcher = nil, match = nil, duration = nil, dist_type = nil, calc = nil, time = nil, dist = nil, mappings = nil, klass = nil, _ = nil;
    ...
    return (function($base) {
      ...
      Opal.cdecl($scope, 'MilePace', ($a = ($b = $scope.get('Struct')).$new, $a.$$p = (TMP_1 = function(){var self = TMP_1.$$s || this;
      ...
      return (Opal.defn(self, '$to_s', function() {
        ...
        }), nil) && 'to_s'}, TMP_1.$$s = self, TMP_1), $a).call($b, "seconds"));

      Opal.cdecl($scope, 'KmPace', ($a = ($c = $scope.get('Struct')).$new, $a.$$p = (TMP_2 = function(){var self = TMP_2.$$s || this;
      ...
      return (Opal.defn(self, '$to_s', function() {
        ...
        }), nil) && 'to_s'}, TMP_2.$$s = self, TMP_2), $a).call($c, "seconds"));

      Opal.cdecl($scope, 'AtPace', ($a = ($d = $scope.get('Struct')).$new, $a.$$p = (TMP_3 = function(){var self = TMP_3.$$s || this;
      ...
      Opal.defn(self, '$to_s', function() {
        ...
        }), nil) && 'identifier';}, TMP_3.$$s = self, TMP_3), $a).call($d, "distance", "seconds"));
      ...
      Opal.cdecl($scope, 'InDuration', ($a = ($e = $scope.get('Struct')).$new, $a.$$p = (TMP_4 = function(){var self = TMP_4.$$s || this;
      ...
      return (Opal.defn(self, '$to_s', function() {
        ...
        }), nil) && 'to_s'}, TMP_4.$$s = self, TMP_4), $a).call($e, "miles", "seconds"));
